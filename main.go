...
import (
	"flag"
	"fmt"
	interfaces "git.fin-dev.ru/dmp/dispatcher-interface.git"
	"git.fin-dev.ru/dmp/dispatcher_rabbit_to_dwh.git/config"
	destination "git.fin-dev.ru/dmp/dwh_client.git"
	crash "git.fin-dev.ru/dmp/rabbitmq_client.git"
	source "git.fin-dev.ru/dmp/rabbitmq_client.git"
